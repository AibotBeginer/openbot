...
class Buffer : public BufferInterface, public tf2::BufferCore {
 public:
   ...
   */
  virtual common::geometry_msgs::TransformStamped lookupTransform(
 ...
 private:
  void SubscriptionCallback(
      const std::shared_ptr<const common::geometry_msgs::TransformStampeds>& transform);
  ...
  void TF2MsgToCyber(const geometry_msgs::TransformStamped& tf2_trans_stamped,
                     common::geometry_msgs::TransformStamped& trans_stamped) const;  // NOLINT

  std::unique_ptr<apollo::cyber::Node> node_;
  std::shared_ptr<apollo::cyber::Reader<common::geometry_msgs::TransformStampeds>> message_subscriber_tf_;
  std::shared_ptr<apollo::cyber::Reader<common::geometry_msgs::TransformStampeds>> message_subscriber_tf_static_;
