  ...
  const std::string & odom_topic)
{
    ...
    odom_cumulate_.mutable_twist()->mutable_twist()->mutable_linear()->set_x(0.0);
    odom_cumulate_.mutable_twist()->mutable_twist()->mutable_linear()->set_y(0.0);
    odom_cumulate_.mutable_twist()->mutable_twist()->mutable_linear()->set_z(0.0);
    odom_cumulate_.mutable_twist()->mutable_twist()->mutable_angular()->set_x(0.0);
    odom_cumulate_.mutable_twist()->mutable_twist()->mutable_angular()->set_y(0.0);
    odom_cumulate_.mutable_twist()->mutable_twist()->mutable_angular()->set_z(0.0);
}

void OdomSmoother::OdomCallback(const std::shared_ptr<common::nav_msgs::Odometry> msg)
{
