...
#include "openbot/system/navigation/behavior_tree/plugins/decorator/rate_controller.hpp"
...
{
  factory.registerNodeType<openbot::system::navigation::behavior_tree::RateController>("RateController");
}
