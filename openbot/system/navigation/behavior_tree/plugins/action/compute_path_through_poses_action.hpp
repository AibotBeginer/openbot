...
#include "openbot/system/navigation/proto/compute_path_through_poses.pb.h"
...
class ComputePathThroughPosesAction
  : public BtActionNode<openbot::navigation::ComputePathThroughPoses>
{
    using Action = openbot::navigation::ComputePathThroughPoses;
...
public:
    ...
    static BT::PortsList providedPorts()
    {
        return providedBasicPorts(
        {
            ...
            BT::OutputPort<common::nav_msgs::Path>("path", "Path created by ComputePathThroughPoses node")
        });
    }
};
