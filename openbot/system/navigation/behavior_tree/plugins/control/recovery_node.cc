...
#include "openbot/system/navigation/behavior_tree/plugins/control/recovery_node.hpp"
...
{
  factory.registerNodeType<openbot::system::navigation::behavior_tree::RecoveryNode>("RecoveryNode");
}