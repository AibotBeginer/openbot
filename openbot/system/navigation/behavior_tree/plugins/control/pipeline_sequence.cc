...
#include "openbot/system/navigation/behavior_tree/plugins/control/pipeline_sequence.hpp"
...
{
  factory.registerNodeType<openbot::system::navigation::behavior_tree::PipelineSequence>("PipelineSequence");
}