...
#include "openbot/system/navigation/behavior_tree/plugins/condition/is_battery_charging_condition.hpp"
...
{
  factory.registerNodeType<openbot::system::navigation::behavior_tree::IsBatteryChargingCondition>("IsBatteryCharging");
}