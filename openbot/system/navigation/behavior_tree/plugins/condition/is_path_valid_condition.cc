...
#include "openbot/system/navigation/behavior_tree/plugins/condition/is_path_valid_condition.hpp"
...
{
  factory.registerNodeType<openbot::system::navigation::behavior_tree::IsPathValidCondition>("IsPathValid");
}