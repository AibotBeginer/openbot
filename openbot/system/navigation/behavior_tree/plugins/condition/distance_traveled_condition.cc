...
#include "openbot/system/navigation/behavior_tree/plugins/condition/distance_traveled_condition.hpp"
...
BT::NodeStatus DistanceTraveledCondition::tick()
{
    ...
    //     {
    //         LOG(DEBUG) << "Current robot pose is not available.";
    //     }
...
{
  factory.registerNodeType<openbot::system::navigation::behavior_tree::DistanceTraveledCondition>("DistanceTraveled");
}