...
void VideoImgViewer::initializeGL() {
  ...
  QImage noImage;
  if (!noImage.load(tr("/opt/openbot/share/openbot/images/no_image.png"))) {
  ...
  video_image_shader_prog_ = RenderableObject::CreateShaderProgram(
      tr("/opt/openbot/share/openbot/shaders/video_image_plane.vert"),
      tr("/opt/openbot/share/openbot/shaders/video_image_plane.frag"));
