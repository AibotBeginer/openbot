...
#ifndef OPENBOT_COMMON_STATE_VECTOR_GENERIC_STATE_HPP_
#define OPENBOT_COMMON_STATE_VECTOR_GENERIC_STATE_HPP_

#include "openbot/common/helper_functions/type_traits.hpp"
#include "openbot/common/helper_functions/types.hpp"

#include "openbot/common/helper_functions/angle_utils.hpp"
#include "openbot/common/helper_functions/type_name.hpp"
#include "openbot/common/state_vector/common_variables.hpp"
...
public:
  ...
  inline OtherStateT copy_into(OtherStateT other_state = OtherStateT{}) const noexcept
  {
    ...
    using CommonVariablesTuple = typename openbot::common::type_traits::intersect<
...
#endif  // OPENBOT_COMMON_STATE_VECTOR_GENERIC_STATE_HPP_
