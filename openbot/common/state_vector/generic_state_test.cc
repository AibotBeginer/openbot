...
using openbot::common::state_vector::GenericState;
using openbot::common::state_vector::FloatState;
using openbot::common::state_vector::AngleVariable;
using openbot::common::state_vector::is_state;
...
TEST(KalmanFilterGenericStateTest, Print) {
  ...
  EXPECT_EQ(
    str_stream.str(),
    "State:\n  openbot::common::state_vector::variable::X: 42\n"
    "  openbot::common::state_vector::variable::Y: 23\n");
}
