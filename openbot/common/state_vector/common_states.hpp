...
#ifndef OPENBOT_COMMON_STATE_VECTOR_COMMON_STATES_HPP_
#define OPENBOT_COMMON_STATE_VECTOR_COMMON_STATES_HPP_
...
#endif  // OPENBOT_COMMON_STATE_VECTOR_COMMON_STATES_HPP_
