...
#ifndef OPENBOT_TRANSFORM_RIGID_TRANSFORM_HPP_
#define OPENBOT_TRANSFORM_RIGID_TRANSFORM_HPP_
...
template <typename T>
std::ostream& operator<<(std::ostream& os, const openbot::common::transform::Rigid2<T>& rigid) 
{
...
// This is needed for gmock.
template <typename T>
std::ostream& operator<<(std::ostream& os, const openbot::common::transform::Rigid3<T>& rigid) 
{
  os << rigid.DebugString();
  return os;
}
...
#endif  // OPENBOT_TRANSFORM_RIGID_TRANSFORM_HPP_
