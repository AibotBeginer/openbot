...
#define REG_MSG_TYPE(TYPE)                                                            \
  MonitorLogBuffer &TYPE(const std::string &msg) {                                    \
    AddMonitorMsgItem(::openbot_bridge::monitor_msgs::MonitorMessageItem::TYPE, msg); \
    Publish();                                                                        \
    return *this;                                                                     \
  }                                                                                   \
  MonitorLogBuffer &TYPE() {                                                          \
    level_ = ::openbot_bridge::monitor_msgs::MonitorMessageItem::TYPE;                \
    return *this;                                                                     \
  }
...
class MonitorLogBuffer 
{
 public:
   ...
   */
  explicit MonitorLogBuffer(const ::openbot_bridge::monitor_msgs::MonitorMessageItem::MessageSource &source);
   ...
   */
  void AddMonitorMsgItem(const ::openbot_bridge::monitor_msgs::MonitorMessageItem::LogLevel log_level,
 ...
 private:
  ...
  ::openbot_bridge::monitor_msgs::MonitorMessageItem::LogLevel level_ = ::openbot_bridge::monitor_msgs::MonitorMessageItem::INFO;
