...
#ifndef OPENBOT_COMMON_OPTIMIZATION_OPTIMIZATION_PROBLEM_HPP_
#define OPENBOT_COMMON_OPTIMIZATION_OPTIMIZATION_PROBLEM_HPP_
...
using openbot::common::types::bool8_t;
...
class  Expression : public common::helper_functions::crtp<Derived>
{
public:
  ...
  using Value = openbot::common::types::float64_t;
...
class OptimizationProblem<Derived, DomainValueT, NumJacobianColsT, NumVarsT,
    ObjectiveT,
...
#endif  // OPENBOT_COMMON_OPTIMIZATION_OPTIMIZATION_PROBLEM_HPP_
