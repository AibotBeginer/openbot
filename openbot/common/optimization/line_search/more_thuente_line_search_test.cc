...
#include "openbot/common/optimization/line_search/more_thuente_line_search.hpp"
#include "openbot/common/optimization/optimization_problem.hpp"
...
using FloatT = openbot::common::types::float64_t;
...
///
class QuadraticFunction : public Expression<QuadraticFunction, Vector, 1, 1>
{
public:
...
///
class FunctionFromFigure3 : public Expression<FunctionFromFigure3, Vector, 1, 1>
{
public:
