...
#include "openbot/common/state_estimation/kalman_filter/kalman_filter.hpp"
#include "openbot/common/state_estimation/measurement/linear_measurement.hpp"
#include "openbot/common/state_estimation/noise_model/wiener_noise.hpp"
...
using openbot::common::state_vector::variable::YAW;
using openbot::common::state_vector::variable::X_VELOCITY;
using openbot::common::state_vector::variable::Y_VELOCITY;
using openbot::common::state_vector::variable::YAW_CHANGE_RATE;
using openbot::common::state_vector::variable::X_ACCELERATION;
using openbot::common::state_vector::variable::Y_ACCELERATION;
using openbot::common::state_vector::variable::YAW_CHANGE_ACCELERATION;
using openbot::common::state_vector::Variable;
using openbot::common::state_vector::FloatState;
using openbot::common::state_estimation::LinearMeasurement;
using openbot::common::state_estimation::KalmanFilter;
using openbot::common::state_estimation::NoiseInterface;
using openbot::common::state_estimation::WienerNoise;
using openbot::common::state_estimation::make_kalman_filter;
using openbot::common::state_estimation::make_correction_only_kalman_filter;
using openbot::common::motion_model::LinearMotionModel;
using openbot::common::motion_model::StationaryMotionModel;
using openbot::common::state_vector::ConstAccelerationXY32;
using openbot::common::state_vector::ConstAccelerationXYYaw32;
...
TEST(TestKalmanFilter, TrackMovingObject) {
  ...
  EXPECT_NEAR(
    kf.state().at<YAW>(),
    openbot::common::helper_functions::wrap_angle(total_float_seconds * speed), eps);
