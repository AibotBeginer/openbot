...
openbot_bridge::common_msgs::PointENU operator+(const openbot_bridge::common_msgs::PointENU enu, const math::Vec2d& xy) 
{
  openbot_bridge::common_msgs::PointENU point;
...
openbot_bridge::common_msgs::PathPoint GetWeightedAverageOfTwoPathPoints(const openbot_bridge::common_msgs::PathPoint& p1,
                                            const openbot_bridge::common_msgs::PathPoint& p2,
                                            const double w1, const double w2) 
{
  openbot_bridge::common_msgs::PathPoint p;
