...
#define PERF_FUNCTION()                               \
  openbot::common::util::TimerWrapper _timer_wrapper_( \
      openbot::common::util::function_signature(AFUNC))
#define PERF_FUNCTION_WITH_NAME(func_name) \
  openbot::common::util::TimerWrapper _timer_wrapper_(func_name)
#define PERF_FUNCTION_WITH_INDICATOR(indicator)       \
  openbot::common::util::TimerWrapper _timer_wrapper_( \
      openbot::common::util::function_signature(AFUNC, indicator))
#define PERF_BLOCK_START()             \
  openbot::common::util::Timer _timer_; \
  _timer_.Start()
