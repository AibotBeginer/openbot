...
#ifndef OPENBOT_COMMON_HELPER_FUNCTIONS__BYTE_READER_HPP_
#define OPENBOT_COMMON_HELPER_FUNCTIONS__BYTE_READER_HPP_
...
#endif  // OPENBOT_COMMON_HELPER_FUNCTIONS__BYTE_READER_HPP_
