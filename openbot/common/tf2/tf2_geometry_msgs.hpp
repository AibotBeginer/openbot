...
#ifndef OPENBOT_COMMON_TF2_GEOMETRY_MSGS_HPP_
#define OPENBOT_COMMON_TF2_GEOMETRY_MSGS_HPP_
...
//  * \deprecated
//  */
// inline KDL::Frame gmTransformToKDL(const geometry_msgs::TransformStamped& t);
// inline
 ...
 */
inline geometry_msgs::Vector3 toMsg(const tf2::Vector3& in)
{
 ...
 */
inline void fromMsg(const geometry_msgs::Vector3& in, tf2::Vector3& out)
{
 ...
 */
template <>
inline const builtin_interfaces::Time& getTimestamp(const geometry_msgs::Vector3Stamped& t) {return t.header.stamp;}
 ...
 */
template <>
inline const std::string& getFrameId(const geometry_msgs::Vector3Stamped& t) {return t.header.frame_id;}
 ...
 */
inline geometry_msgs::Vector3Stamped toMsg(const geometry_msgs::Vector3Stamped& in)
{
  return in;
}
 ...
 */
inline void fromMsg(const geometry_msgs::Vector3Stamped& msg, geometry_msgs::Vector3Stamped& out)
{
  out = msg;
}
 ...
 */
inline geometry_msgs::Vector3Stamped toMsg(const tf2::Stamped<tf2::Vector3>& in)
{
 ...
 */
inline void fromMsg(const geometry_msgs::Vector3Stamped& msg, tf2::Stamped<tf2::Vector3>& out)
{
 ...
 * \return The Vector3 converted to a geometry_msgs message type.
 */
inline geometry_msgs::Point& toMsg(const tf2::Vector3& in, geometry_msgs::Point& out)
{
  out.x = in.getX();
  out.y = in.getY();
  out.z = in.getZ();
 ...
 * \param out The Vector3 converted to a tf2 type.
 */
inline void fromMsg(const geometry_msgs::Point& in, tf2::Vector3& out)
{
  out = tf2::Vector3(in.x, in.y, in.z);
}
 ...
 */
template <>
inline const builtin_interfaces::Time& getTimestamp(const geometry_msgs::PointStamped& t)  {return t.header.stamp;}
 ...
 */
template <>
inline const std::string& getFrameId(const geometry_msgs::PointStamped& t)  {return t.header.frame_id;}
 ...
 * \return The input argument.
 */
inline geometry_msgs::PointStamped toMsg(const geometry_msgs::PointStamped& in)
{
  return in;
}
 ...
 * \param out The input argument.
 */
inline void fromMsg(const geometry_msgs::PointStamped& msg, geometry_msgs::PointStamped& out)
{
  out = msg;
}
 ...
 */
inline geometry_msgs::PointStamped toMsg(const tf2::Stamped<tf2::Vector3>& in, geometry_msgs::PointStamped & out)
{
  out.header.stamp = in.stamp_;
  out.header.frame_id = in.frame_id_;
  out.point.x = in.getX();
 ...
 */
inline void fromMsg(const geometry_msgs::PointStamped& msg, tf2::Stamped<tf2::Vector3>& out)
{
  out.stamp_ = msg.header.stamp;
  out.frame_id_ = msg.header.frame_id;
 ...
 */
inline geometry_msgs::Quaternion toMsg(const tf2::Quaternion& in)
{
 ...
 */
template <>
inline const builtin_interfaces::Time& getTimestamp(const geometry_msgs::QuaternionStamped& t)  
{
 ...
 */
template <>
inline const std::string& getFrameId(const geometry_msgs::QuaternionStamped& t)  {return t.header.frame_id;}
 ...
 * \return The input argument.
 */
inline geometry_msgs::QuaternionStamped toMsg(const geometry_msgs::QuaternionStamped& in)
{
  return in;
}
...
template <>
inline geometry_msgs::QuaternionStamped toMsg(const tf2::Stamped<tf2::Quaternion>& in);
...
template<>
inline void fromMsg(const geometry_msgs::QuaternionStamped& in, tf2::Stamped<tf2::Quaternion>& out);
...
template <>
inline
  const builtin_interfaces::Time& getTimestamp(const geometry_msgs::PoseStamped& t)  {return t.header.stamp;}
...
template <>
inline
  const builtin_interfaces::Time& getTimestamp(const geometry_msgs::PoseWithCovarianceStamped& t)  {return t.header.stamp;}
 ...
 */
template <>
inline const builtin_interfaces::Time& getTimestamp(const geometry_msgs::TransformStamped& t)  {return t.header.stamp;}
 ...
 */
template <>
inline const std::string& getFrameId(const geometry_msgs::TransformStamped& t)  {return t.header.frame_id;}
...
*/
inline std::vector<double> transformCovariance(const std::vector<double>& cov_in, const tf2::Transform& transform)
{
  /**
...
template <>
inline
const builtin_interfaces::Time& getTimestamp(const geometry_msgs::WrenchStamped& t) {return t.header.stamp;}
...
#endif // OPENBOT_COMMON_TF2_GEOMETRY_MSGS_HPP_
