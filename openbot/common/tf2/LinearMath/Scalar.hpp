...
#ifndef OPENBOT_COMMON_TF2_LINEARMATH_SCALAR_HPP_
#define OPENBOT_COMMON_TF2_LINEARMATH_SCALAR_HPP_
...
#define TF2_DEBUG
		...
		#else
			//#define TF2_HPP_AS_ALIGNED_ALLOCATOR
...
//			#pragma warning(disable:4786) // Disable the "debug name too long" warning
			...
			#include <ppcintrinsics.h>
 			#define TF2_HPP_AVE_NATIVE_FSEL
...
#define TF2SIMD_HPP_ALF_PI      (TF2SIMD_2_PI * tf2Scalar(0.25))
...
#define TF2_DECLARE_HPP_ANDLE(name) typedef struct name##__ { int unused; } *name
...
#endif // OPENBOT_COMMON_TF2_LINEARMATH_SCALAR_HPP_
