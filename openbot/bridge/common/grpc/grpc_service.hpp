...
class GrpcServerImpl final : public ::openbot_bridge::service_msgs::ROS2SenorService::Service 
{
public:
    /* construct function
    */
    ...
    ::grpc::Status PublishImageSennorMessages(::grpc::ServerContext* context, 
        const ::openbot_bridge::ros2_msgs::sensor_msgs::Image* request, google::protobuf::Empty* response) override;
