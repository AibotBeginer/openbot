...
#include "openbot/bridge/components/udp_bridge_sender_component.hpp"

#include "openbot/bridge/common/bridge_proto_serialized_buf.hpp"
#include "openbot/bridge/common/macro.hpp"
#include "openbot/bridge/common/util.hpp"
...
using openbot::bridge::net::UDPBridgeSenderRemoteInfo;
using apollo::cyber::io::Session;

template <typename T>
bool UDPBridgeSenderComponent<T>::Init() {
  AINFO << "UDP bridge sender init, startin...";
  openbot::bridge::net::UDPBridgeSenderRemoteInfo udp_bridge_remote;
