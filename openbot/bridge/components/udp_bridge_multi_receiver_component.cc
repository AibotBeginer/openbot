...
#include "openbot/bridge/components/udp_bridge_multi_receiver_component.hpp"

#include "cyber/time/clock.h"

#include "openbot/bridge/common/bridge_proto_diser_buf_factory.hpp"
...
bool UDPBridgeMultiReceiverComponent::Init() {
  ...
  net::UDPBridgeReceiverRemoteInfo udp_bridge_remote;
